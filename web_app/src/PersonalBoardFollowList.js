...
class PersonalBoardFollowList extends React.Component {
              ...
              >
                <Card style={{minWidth: 250, minHeight: 100, margin: 7}} >
                  ...
                  <CardActions>
                      ...
                      <Button>
                          <Link to={`/boards/${board.parentID}/${board.boardID}`}>
                              View
                          </Link>
                      </Button>
                  </CardActions>
    ...
    render() {
        ...
        return (
         <div>
            <h1>Personal Boards Followed</h1>
            <body>
            {this.getBoardCards()}
            </body>
         </div>   
...
export default withRouter(PersonalBoardFollowList);